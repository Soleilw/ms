<template>
	<div id="wrap">
		...
		<div class="summary">
			<!-- 地图分布数据显示 -->
			<div class="show-map">
				<div class="title"><i class="el-icon-d-arrow-right" style="color: #2A9F93;padding-right: 5px;font-weight: 1000;"><span
						 style="color: #2A9F93;">出租屋分布</span></i></div>
			...
			<div class="data">
				<div class="data-1">
					...
					<div style="width: 30%;border: 1px solid #2A9F93;margin: 10px 0;">
						<div class="title">
							<i class="el-icon-d-arrow-right" style="color: #2A9F93;padding-right: 5px;font-weight: 1000;"><span style="color: #2A9F93;">实时出租屋预览</span></i>
					...
					<div style="width: 50%;border: 1px solid #2A9F93;margin: 10px;">
						<div class="title">
							<i class="el-icon-d-arrow-right" style="color: #2A9F93;padding-right: 5px;font-weight: 1000;"><span style="color: #2A9F93;">人数统计</span></i>
							<div class="search-input">
								<input type="text" style="color: #fff;padding-right: 5px;font-weight: 1000;" placeholder="请输入查询的出租屋">
								<i class="el-icon-search" style="color: #fff;"></i>
							</div>
